        ...
        NavigationStack {
            List {
                ...
                Section {
                    ...
                    Text("Widgets show the latest radar status saved by the app. Release Model Radar has no accounts and no tracking — preferences, favourites, and reminders stay on this device.")
                        .foregroundStyle(Theme.dim)
                }
                .listRowBackground(Theme.panel)
            }
